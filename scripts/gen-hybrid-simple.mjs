...
box(
  rtl('<b>3 · המודל מכריז לחדר:</b> "אני צריך get_airport_weather · BOS"<br>ההכרזה נשמעת ב<b>שני</b> החיבורים, עם השם והארגומנטים. הדפדפן שומע ושותק — השם לא ברשימה שלו.'),
  NOTE('#fde8e6', RED),
  OA - 330,
  340,
  660,
...
box(
  rtl(
    '<b>ומה זה לא עושה</b> — שני החיבורים על סשן אחד, אז הדפדפן שומע שהקריאה קרתה. וכשהשרת מזריק את התוצאה, OpenAI משדר את הפריט ל<b>כל</b> החיבורים — אז הדפדפן <b>כן מקבל את ה-JSON</b>. 15.3 מעלות מגיעות אליו גם בלי שביקש. ' +
      'מה שנשלט הוא <b>מי מבצע</b> — מי מחזיק את הקרדנציאלס, מי יוצא לאינטרנט, ומי יכול לקרוא לכלי עם ארגומנטים משלו. <b>לא</b> מי רואה. לסודיות מלאה כל השיחה צריכה לעבור בשרת — וזה פי 4-5 בלטנסי.',
  ),
